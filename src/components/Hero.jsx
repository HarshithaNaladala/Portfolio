    ...
    <section className="flex items-center justify-center min-h-screen bg-[url('/path_to_background_image.jpg')] bg-cover text-white">
      <div className="text-center flex lg:flex-row gap-10 mt-15 flex-col sm:mt-15 md:mt-15">
        <div className="flex-1 px-5">
          <h1 className='font-black text-white lg:text-[30px] sm:text-[20px] xs:text-[20px] mt-3 text-gray-400'>Hello, I'm</h1>
          <h1 className='font-black text-white lg:text-[50px] sm:text-[40px] xs:text-[40px] mt-3'>Harshitha Naladala</h1>
          <p className='font-black text-white lg:text-[35px] sm:text-[25px] xs:text-[25px] mt-3 text-gray-300 mb-8'>Full-Stack Developer</p>
        ...
        <div className='flex flex-col justify-center items-center px-5'>
          <img src="/profileimg.jpg" alt="Harshitha" className="w-80 h-80 rounded-full object-cover mb-4 sm:w-60 sm:h-60"/>
        </div>
      </div>
    </section>
  );
